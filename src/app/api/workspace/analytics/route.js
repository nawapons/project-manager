...
export async function GET(request) {
    ...
    const { count: lastMonthTasksCount } = await supabase.from("tasks").select("*", { count: 'exact', head: true }).eq("workspacesId", workspaceId).gte("created_at", lastMonthStart.toISOString()).lte("created_at", lastMonthEnd.toISOString())
